    ...
    <section class="section blog-wrap">
                    ...
                    <div class="row">
                        <div class="col-lg-12 mb-5">
                            <div class="single-blog-item">
                                <img src="https://admincmiartikel.cmihospital.com/gambar_artikel/{{ $artikel['0']['gambar_artikel'] }}" title="" alt="" class="img-fluid">

                                <div class="blog-item-content mt-5">
                                    <div class="blog-item-meta mb-3">
                                        {{-- <span class="text-color-2 text-capitalize mr-3"><i class="icofont-book-mark mr-2"></i> Total View : {{ $artikel->total_views }}</span> &nbsp &nbsp --}}
                                        <span class="text-muted text-capitalize mr-3"><i class="icofont-comment mr-2"></i>5 Comments</span> &nbsp &nbsp
                                        <span class="text-black text-capitalize mr-3"><i class="icofont-calendar mr-2"></i> 28th January 2019</span>
                                    </div> 

                                    <h2 class="mb-4 text-md"><a href="#">{{ $artikel['0']['judul'] }}</a></h2>
                                    <p class="lead mb-4">asdansdkjasn asdna nka nklajnsd asdnaj dn akndkasnd  njand andjkan dkajs lasd jndaks ndjas!</p>
                                    <p style="text-align: justify;">{{ $artikel['0']['isi_artikel'] }}</p>
        ...
        <section id="popular-courses" class="courses">
            ...
            <div class="section-title">
                ...
                <p style="font-size: 23px">Related Posts</p>
            </div>
                ...
                @if(isset($related_post))
                    ...
                    <div class="col-lg-4 col-md-4 mb-5">
                        ...
                        <div class="blog-item-content">
                            ...
                            <span class="text-black text-capitalize mr-3"><i class="icofont-calendar mr-1"></i> {{$related_posts->created_at}}</span>
                            </div> 
                            <h1 class="mt-3 mb-3" style="font-size: 20px;"><a href="{{ url('artikel-detail/'.$related_posts->id) }}">{{ $related_posts->judul }}</a></h1>
                            ...
                            <a href="{{ url('artikel-detail/'.$related_posts->id) }}" class="btn btn-main btn-icon btn-round-full">Read More <i class="icofont-simple-right ml-2  "></i></a>
                        </div>
                        </div>
                    </div>
                    @endforeach
