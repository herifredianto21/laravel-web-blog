...
(6, '2022_04_07_031657_create_artikel_table', 1),
(7, '2022_05_20_092456_create_sessions_table', 1);
...
--
-- Table structure for table `pengunjung_artikels`
--

CREATE TABLE `pengunjung_artikels` (
  `id` bigint(20) UNSIGNED NOT NULL,
...
--
-- Dumping data for table `pengunjung_artikels`
--

INSERT INTO `pengunjung_artikels` (`id`, `ip`, `slug`, `countryName`, `regionName`, `cityName`, `tanggal`, `created_at`, `updated_at`) VALUES
(4, 'https://127.0.0.1', 'bahaya-merokok-yang-mengakibatkan-resiko-terkena-penyakit-gagal-ginjal', 'Indonesia', 'West Java', 'Bandung', '2022-05-23', '2022-05-23 00:05:47', '2022-05-23 00:05:47'),
(5, 'https://127.0.0.1', 'transplantasi-dan-cuci-darah-sebagai-cara-instan-penderita-ginjal', 'Indonesia', 'West Java', 'Bandung', '2022-05-23', '2022-05-23 00:25:22', '2022-05-23 00:25:22'),
(6, 'https://127.0.0.1', 'apakah-penderita-tersebut-harus-melakukan-cuci-darah-seumur-hidupnya', 'Indonesia', 'West Java', 'Bandung', '2022-05-23', '2022-05-23 00:25:42', '2022-05-23 00:25:42'),
(7, 'https://127.0.0.1', 'apakah-penderita-tersebut-harus-melakukan-cuci-darah-seumur-hidupnya', 'Indonesia', 'West Java', 'Bandung', '2022-05-24', '2022-05-23 18:13:19', '2022-05-23 18:13:19'),
(8, 'https://127.0.0.1', 'bahaya-merokok-yang-mengakibatkan-resiko-terkena-penyakit-gagal-ginjal', 'Indonesia', 'West Java', 'Bandung', '2022-05-24', '2022-05-23 18:13:49', '2022-05-23 18:13:49'),
(9, 'https://127.0.0.1', 'apakah-penderita-tersebut-harus-melakukan-cuci-darah-seumur-hidupnya', 'Indonesia', 'West Java', 'Bandung', '2022-05-25', '2022-05-24 18:21:25', '2022-05-24 18:21:25'),
(10, 'https://127.0.0.1', 'bahaya-merokok-yang-mengakibatkan-resiko-terkena-penyakit-gagal-ginjal', 'Indonesia', 'West Java', 'Bandung', '2022-05-25', '2022-05-24 19:33:29', '2022-05-24 19:33:29');

-- --------------------------------------------------------

--
-- Table structure for table `pengunjung_was`
--

CREATE TABLE `pengunjung_was` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `ip` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `countryName` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `regionName` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
--
-- Dumping data for table `pengunjung_was`
--

INSERT INTO `pengunjung_was` (`id`, `ip`, `countryName`, `regionName`, `cityName`, `tanggal`, `created_at`, `updated_at`) VALUES
(1, 'https://127.0.0.1', 'Indonesia', 'West Java', 'Bandung', '2022-05-23', '2022-05-23 00:56:06', '2022-05-23 00:56:06'),
(2, 'https://127.0.0.1', 'Indonesia', 'West Java', 'Bandung', '2022-05-24', '2022-05-23 18:14:09', '2022-05-23 18:14:09');

-- --------------------------------------------------------

--
-- Table structure for table `pengunjung_webs`
--

CREATE TABLE `pengunjung_webs` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `ip` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `countryName` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `regionName` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
--
-- Dumping data for table `pengunjung_webs`
--

INSERT INTO `pengunjung_webs` (`id`, `ip`, `countryName`, `regionName`, `cityName`, `tanggal`, `created_at`, `updated_at`) VALUES
(1, 'https://127.0.0.1', 'Indonesia', 'West Java', 'Bandung', '2022-05-21', '2022-05-21 14:29:07', '2022-05-21 14:29:07'),
(2, 'https://127.0.0.1', 'Indonesia', 'West Java', 'Bandung', '2022-05-23', '2022-05-22 18:13:59', '2022-05-22 18:13:59');
...
('9MYBjLoc6M4yfRBQF6KacXzKULpXa7mVTyTfprt8', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/101.0.4951.67 Safari/537.36', 'YTozOntzOjY6Il90b2tlbiI7czo0MDoiOFMxVEFNVFZLZlpGUzFJRm44Qko2OGJEdVpmdWx6Mmh5T0QxVG5NSyI7czo5OiJfcHJldmlvdXMiO2E6MTp7czozOiJ1cmwiO3M6MjE6Imh0dHA6Ly8xMjcuMC4wLjE6ODAwMCI7fXM6NjoiX2ZsYXNoIjthOjI6e3M6Mzoib2xkIjthOjA6e31zOjM6Im5ldyI7YTowOnt9fX0=', 1653448195),
('bDloMvdsKRJVFktFy4uUm1IVCvC37lJVmdYNHptM', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/101.0.4951.67 Safari/537.36', 'YTozOntzOjY6Il90b2tlbiI7czo0MDoidDQwS2sxYlFkSnlJTFVDN0I3RkZhYklLZlJsaXV0ZmNCQ2RwRzM4dCI7czo2OiJfZmxhc2giO2E6Mjp7czozOiJvbGQiO2E6MDp7fXM6MzoibmV3IjthOjA6e319czo5OiJfcHJldmlvdXMiO2E6MTp7czozOiJ1cmwiO3M6Mjg6Imh0dHA6Ly8xMjcuMC4wLjE6ODAwMC9ncmFmaWsiO319', 1653365393),
('OyaZrVeWCbTLjLnuG20sCYSFpe36pPE1Mo1E4S9i', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/101.0.4951.67 Safari/537.36', '', 1653462687);
...
CREATE TABLE `users` (
  ...
  `lama_keluhan` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `users` (`id`, `name`, `umur`, `domisili`, `no_telp`, `keluhan`, `lama_keluhan`, `email_verified_at`, `two_factor_secret`, `two_factor_recovery_codes`, `two_factor_confirmed_at`, `remember_token`, `current_team_id`, `profile_photo_path`, `created_at`, `updated_at`) VALUES
(1, 'Heru Fredianto', 0, '', 0, '', '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2022-05-20 02:57:51', '2022-05-20 02:57:51'),
(2, 'Mayang Puspita Sari', 45, 'Bandung', 2, 'Sakit Hati', '4 tahun', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2022-05-22 18:36:14', '2022-05-22 18:36:14'),
(3, 'Ginanjar', 67, 'Cianjur', 1, 'Bengek', '2 tahun', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2022-05-23 18:40:54', '2022-05-23 18:40:54'),
(4, 'Sukiman', 67, 'Jakarta', 2, 'Ginjal', '4 tahun', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2022-05-23 19:07:44', '2022-05-23 19:07:44');
...
--
-- Indexes for table `pengunjung_artikels`
--
ALTER TABLE `pengunjung_artikels`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `pengunjung_was`
--
ALTER TABLE `pengunjung_was`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `pengunjung_webs`
--
ALTER TABLE `pengunjung_webs`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `pengunjung_artikels`
--
ALTER TABLE `pengunjung_artikels`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT for table `pengunjung_was`
--
ALTER TABLE `pengunjung_was`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `pengunjung_webs`
--
ALTER TABLE `pengunjung_webs`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
